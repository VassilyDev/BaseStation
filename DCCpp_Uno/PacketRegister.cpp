...
void RegisterList::setThrottle(char *s) volatile {
  ...
  if (DOUBLE_SERIAL) {
    INTERFACE1.print("<T");
    INTERFACE1.print(nReg); INTERFACE.print(" ");
    INTERFACE1.print(tSpeed); INTERFACE.print(" ");
    INTERFACE1.print(tDirection);
    INTERFACE1.print(">");
  }
...
void RegisterList::writeTextPacket(char *s) volatile {
  ...
  if (nBytes < 2 || nBytes > 5) { // invalid valid packet
    ...
    if (DOUBLE_SERIAL) {
      INTERFACE1.print("<mInvalid Packet>");
    }
    return;
  }
...
void RegisterList::readCV(char *s) volatile {
  ...
  if (DOUBLE_SERIAL) {
    INTERFACE1.print("<r");
    INTERFACE1.print(callBack);
    INTERFACE1.print("|");
    INTERFACE1.print(callBackSub);
    INTERFACE1.print("|");
    INTERFACE1.print(cv + 1);
    INTERFACE1.print(" ");
    INTERFACE1.print(bValue);
    INTERFACE1.print(">");
  }
...
void RegisterList::printPacket(int nReg, byte *b, int nBytes, int nRepeat) volatile {
  ...
  if (DOUBLE_SERIAL) {
    INTERFACE1.print("<*");
    INTERFACE1.print(nReg);
    INTERFACE1.print(":");
    for (int i = 0; i < nBytes; i++) {
      INTERFACE1.print(" ");
      INTERFACE1.print(b[i], HEX);
    }
    INTERFACE1.print(" / ");
    INTERFACE1.print(nRepeat);
    INTERFACE1.print(">");
  }
